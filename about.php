...
include ('includes/nav.php');
	...
	<section id="showcase" >
		...
		<p>The club aims at providing students with opportunities to discuss various issues dealing with computing technology outside the lecture rooms to create a greater understanding of technology.The students plan guest lectures and special events during their academic year.In addition, the club members strive to educate the masses on the use of technology.</p>
		<h1>Mission</h1>
		<p>To create an environment where students with varying degrees of IT skills can work together to enhance their academic training and technical expertise through partnership with the local IT industry.</p>
	</article>
	<aside id="sidebar">
		<div class="dark">
